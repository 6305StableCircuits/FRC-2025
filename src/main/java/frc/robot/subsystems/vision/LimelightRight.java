...
public class LimelightRight extends Subsystem {
    ...
    public static LimelightRight instance = null;
    public static LimelightRight getInstance() {
        if(instance == null) {
            instance = new LimelightRight();
        }
        return instance;
    }
    ...
    public void readPeriodicInputs() {
        ...
        pose = NetworkTableInstance.getDefault().getTable("limelight-right").getEntry("camerapose_targetspace").getDoubleArray(new double[6]);
        yaw = NetworkTableInstance.getDefault().getTable("limelight-right").getEntry("botpose_targetspace").getDoubleArray(new double[6])[4];
    }
    ...
    public void outputTelemetry() {
        SmartDashboard.putNumber("LimelightRightX", x);
        SmartDashboard.putNumber("LimelightRightY", y);
        SmartDashboard.putNumber("LimelightRightArea", area);
        SmartDashboard.putBoolean("RightLock?", v);
    }
}
