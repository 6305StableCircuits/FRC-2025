...
public class RobotContainer {
    ...
    private void configureBindings() {
        ...
        drivetrain.registerTelemetry(logger::telemeterize); // found out what the `::` means, basically it lets you pass a method to a function (fn(Math::max) is equivalent to fn(Math.max) in JS)
    }
